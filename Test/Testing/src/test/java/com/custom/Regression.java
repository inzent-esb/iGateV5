...
public interface Regression
{
  ...
  public static final String ASYNC_VALID_JDBC_URL = "jdbc:mysql://218.50.65.12/igate5?useUnicode=true&serverTimezone=UTC";
  //public static final String COR_JDBC_URL = "jdbc:mysql://192.168.20.201/igate5?useUnicode=true&serverTimezone=UTC";
  public static final String ASYNC_VALID_JDBC_DRIVER = "com.mysql.cj.jdbc.Driver";
  public static final String ASYNC_VALID_JDBC_ID = "igate5";
  public static final String ASYNC_VALID_JDBC_PASSWORD = "igate5";
  public static final String ASYNC_VALID_FLAG = "T";
  
  public static final String COR_JDBC_URL = "jdbc:mysql://218.50.65.12/eai?useUnicode=true&serverTimezone=UTC";
  //public static final String COR_JDBC_URL = "jdbc:mysql://192.168.20.201/igate5?useUnicode=true&serverTimezone=UTC";
  public static final String COR_JDBC_DRIVER = "com.mysql.cj.jdbc.Driver";
  public static final String COR_JDBC_ID = "eai";
  public static final String COR_JDBC_PASSWORD = "inzent";
  
  public static final String EDW_JDBC_URL = "jdbc:oracle:thin:@//218.50.65.12/orcl";
  //public static final String EDW_JDBC_URL = "jdbc:oracle:thin:@//192.168.20.201/orcl";
  public static final String EDW_JDBC_DRIVER = "oracle.jdbc.driver.OracleDriver";
  public static final String EDW_JDBC_ID = "EAI";
  public static final String EDW_JDBC_PASSWORD = "inzent";
  ...
  public static final String ECHO_CONNECTOR_ADDRESS = "218.50.65.12" ;
//  public static final String ECHO_CONNECTOR_ADDRESS = "192.168.20.202" ;
  public static final int ECHO_KFB_TAX_CONNECTOR_PORT = 6113 ;
  public static final String echo_username ="igtecho";
  public static final String echo_password = "inzent";
  ...
  public static final String username ="igate5";
  public static final String password = "inzent";
