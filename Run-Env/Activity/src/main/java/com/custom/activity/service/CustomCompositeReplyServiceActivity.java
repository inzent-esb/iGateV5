...
public class CustomCompositeReplyServiceActivity extends CompositeReplyServiceActivity implements CustomHandlerConstants
{
  public CustomCompositeReplyServiceActivity(Activity meta)
  {
    super(meta) ;
  }
