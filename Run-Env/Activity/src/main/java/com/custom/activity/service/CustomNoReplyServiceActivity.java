...
import com.inzent.igate.activity.service.NoReplyServiceActivity ;
...
public class CustomNoReplyServiceActivity extends NoReplyServiceActivity implements CustomHandlerConstants
{
  public CustomNoReplyServiceActivity(Activity meta)
  {
    super(meta) ;
  }
  ...
  {
    request.setFieldValue(SYNC_MODE_PATH, "N") ;
