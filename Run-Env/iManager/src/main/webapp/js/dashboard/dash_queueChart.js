	...
	function initFunc() {
		...
		this.updateTarget = function(targetId, updateOption) {
			...
			if (updateOption.isDataEmpty) {
				...
				targetInfo.element.find('[name=instanceMessageGraph]').width('0%');
				targetInfo.element.find('[name=instanceMessageNum]').text('0');
				targetInfo.element.find('[name=instanceConsumerGraph]').width('0%');
				targetInfo.element.find('[name=instanceConsumerNum]').text('0');				
