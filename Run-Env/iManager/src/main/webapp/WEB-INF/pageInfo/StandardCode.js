const info = {
	...
	search: {
		...
		list: [
			...
			{ type: 'text', vModel: 'pk.standardCode', label: this.$t('igate.standardCode'), placeholder: this.$t('head.searchCode') },
			{
				type: 'dataList',
				vModel: 'pageSize',
				label: this.$t('head.listCount'),
	...
	detail: {
		...
		tabList: [
				...
				content: [
					[
						[
							...
							{ type: 'text', vModel: 'pk.standardCode', label: this.$t('igate.standardCode'), isPK: true, },
						],
						[
							{ type: 'text', vModel: 'message1', label: this.$t('igate.standardCode.message1') },
							{ type: 'text', vModel: 'message2', label: this.$t('igate.standardCode.message2') },
							{ type: 'text', vModel: 'message3', label: this.$t('igate.standardCode.message3') },
							{ type: 'text', vModel: 'localCode', label: this.$t('igate.standardCode.localCode') },
						]
					],
				]
			},
			{
				...
				content: [
					{ type: 'text', vModel: 'pk.localeCode', label: this.$t('igate.message.locale') },
					{ type: 'text', vModel: 'message1', label: this.$t('igate.standardCode.message1') },
					{ type: 'text', vModel: 'message2', label: this.$t('igate.standardCode.message2') },
					{ type: 'text', vModel: 'message3', label: this.$t('igate.standardCode.message3') },
				]
