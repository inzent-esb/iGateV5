const info = {
	...
	search: {
		load: true,
		list: [			
			{ type: 'text', 	vModel: 'roleId',		label: this.$t('head.id'),			placeholder: this.$t('head.searchId'), regExpType: 'searchId' },
			{ type: 'text', 	vModel: 'roleDesc',   	label: this.$t('head.description'), 		placeholder: this.$t('head.searchComment'), regExpType: 'desc' },
			{
				type: 'dataList',
				vModel: 'pageSize',
		...
		tabList: [
			...
			},
			{
				...
				addRowInfo: {
					type: 'modal',
					modalInfo: {
						title: this.$t('common.privilege') + ' ' + this.$t('head.id'),
						search: {
							list: [
								{ type: 'text', 	vModel: 'privilegeId',		label: this.$t('head.id'),	placeholder: this.$t('head.searchId'), regExpType: 'id' },
