const info = {
	...
	search: {
		...
		list: [
			...
			{ type: 'text', vModel: 'jobName', label: this.$t('head.name'), placeholder: this.$t('head.searchName'), regExpType: 'name' },
			{
				type: 'select',
				vModel: 'jobType',
	...
	detail: {
		...
		tabList: [
			...
			},
			{
				...
				content: [
					{ type: 'text', vModel: 'parameterValue', label: this.$t('common.property.value') },
					{ type: 'text', vModel: 'parameterDesc', label: this.$t('head.description'), regExpType: 'desc' },
				],
			},
			{
				type: 'bundle',
