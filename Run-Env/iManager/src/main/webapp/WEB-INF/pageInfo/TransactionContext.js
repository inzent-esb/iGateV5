const info = {
	...
	search: {
		load: true,
		list: [
			{ type: 'text', vModel: 'variableId', label: this.$t('head.id'), placeholder: this.$t('head.searchId'), regExpType: 'searchId' },
			{ type: 'text', vModel: 'variableType', label: this.$t('common.type'), placeholder: this.$t('head.searchData'), regExpType: 'desc' },
			{ type: 'text', vModel: 'variableDesc', label: this.$t('head.description'), placeholder: this.$t('head.searchComment'), regExpType: 'desc' },
			{
				type: 'dataList',
				vModel: 'pageSize',
