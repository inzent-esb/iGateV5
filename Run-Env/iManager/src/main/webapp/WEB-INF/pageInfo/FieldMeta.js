const info = {
	...
	search: {
		load: true,
		list: [
			{ type: 'text', vModel: 'pk.metaDomain', label: this.$t('igate.fieldMeta.metaDomain'), placeholder: this.$t('head.searchData') },
			{ type: 'text', vModel: 'fieldId', label: this.$t('head.id'), placeholder: this.$t('head.searchId'), regExpType: 'searchId' },
			{ type: 'text', vModel: 'fieldName', label: this.$t('head.name'), placeholder: this.$t('head.searchName'), regExpType: 'name' },
			{
				type: 'select',
				vModel: 'fieldType',
			...
			{ type: 'text', vModel: 'fieldDesc', label: this.$t('head.description'), placeholder: this.$t('head.searchComment'), regExpType: 'desc' },
			{
				type: 'dataList',
				vModel: 'pageSize',
				...
				},
				{
		            ...
		            formatter: function(value) {
		            	const msgObj = {
		            		...
		            		'P': this.$t("igate.fieldMeta.fieldType.packedDecimal"),
