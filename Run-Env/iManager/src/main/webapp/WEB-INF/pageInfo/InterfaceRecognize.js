			...
			list: [
				...
				{ 
					...
					modalInfo: {
						...
						search: {
							list: [
								{ type: 'text', vModel: 'interfaceId', label: this.$t('head.id'), placeholder: this.$t('head.searchId'), regExpType: 'searchId' },
								{ type: 'text', vModel: 'interfaceName', label: this.$t('head.name'), placeholder: this.$t('head.searchName'), regExpType: 'name' },
								{
									type: 'dataList',
									vModel: 'pageSize',
									label: this.$t('head.listCount'),
