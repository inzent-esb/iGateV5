const info = {
	...
	search: {
		load: true,
		list: [
			{ type: 'text', vModel: 'exceptionCode', label: this.$t('igate.exceptionCode'), placeholder: this.$t('head.searchCode') },
			{
				type: 'modal',
				vModel: 'standardCode',
						...
						list: [
							{
								type: 'modal',
								vModel: 'pk.adapterId',
								label: this.$t('igate.standardCode') + ' ' + this.$t('igate.adapter') + ' ' + this.$t('head.id'),
					...
					grid: {
						...
						options: {
							columns: [
								{
									name: 'pk.adapterId',
									header: this.$t('igate.standardCode') + ' ' + this.$t('igate.adapter') + ' ' + this.$t('head.id'),
									align: 'left',
									width: '15%',
								},
								{
								...
								{
									name: 'message1',
									header: this.$t('igate.standardCode.message1'),
									align: 'left',
									width: '20%',
								},
								{
									name: 'message2',
									header: this.$t('igate.standardCode.message2'),
									align: 'left',
									width: '20%',
								},
								{
									name: 'message3',
									header: this.$t('igate.standardCode.message3'),
									align: 'left',
									width: '20%',
								},
								{
									name: 'localCode',
									header: this.$t('igate.standardCode.localCode'),
									align: 'left',
									width: '12%',
								},
							],
			...
			{ type: 'text', vModel: 'exceptionDesc', label: this.$t('head.description'), placeholder: this.$t('head.searchComment') },			
			{
				type: 'dataList',
				vModel: 'pageSize',
				label: this.$t('head.listCount'),
		...
		tabList: [
			{
				...
				content: [
					[
						[
							{ type: 'text', vModel: 'exceptionCode', label: this.$t('igate.exceptionCode'), isPK: true },							
						],					
						[]
					],
					[
			...
			},
			{
				...
				content: [
					{ type: 'text', vModel: 'pk.propertyKey', label: this.$t('common.property.key'), regExpType: 'id' },
					{ type: 'text', vModel: 'propertyValue', label: this.$t('common.property.value'), regExpType: 'value' },
				],
			},
		],
	},
