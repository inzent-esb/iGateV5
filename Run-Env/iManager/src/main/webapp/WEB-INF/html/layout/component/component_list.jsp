	...
	<div class="sub-bar">
		<div class="ml-auto form-inline m-full">
			...
			<span id="refreshArea">
				...
				<a id="refreshBtn" href="javascript:void(0);" class="btn btn-m" v-on:click="refresh"><i v-bind:class="{ 'icon-play' : !isStartRefresh, 'icon-pause' : isStartRefresh }"></i><span class="hide"><fmt:message>igate.refresh</fmt:message></span></a>			
			</span>
			<a id="importBtn"       href="javascript:void(0);" class="btn btn-m btn-primary" 		      	v-on:click="goImport" style="display: none;"><fmt:message>head.import</fmt:message></a>
			<a id="downloadBtn"     href="javascript:void(0);" class="btn btn-m btn-primary" 			  	v-on:click="downloadFile" style="display: none;"><i class="icon-result"></i><span class="hide"><fmt:message>head.excel.output</fmt:message></span></a>			
			<a id="makeBtn"         href="javascript:void(0);" class="viewGroup btn btn-m btn-primary"    	v-on:click="make" style="display: none;"><fmt:message>head.make</fmt:message></a>
			<a id="startBtn"        href="javascript:void(0);" class="viewGroup btn btn-m"    				v-on:click="start" style="display: none;"><i class="icon-play"></i><fmt:message>head.execute</fmt:message></a>
			<a id="stopBtn"         href="javascript:void(0);" class="viewGroup btn btn-m"    				v-on:click="stop" style="display: none;"><i class="icon-pause"></i><fmt:message>head.stop</fmt:message></a>
			<a id="stopForceBtn"    href="javascript:void(0);" class="viewGroup btn btn-m"    				v-on:click="stopForce" style="display: none;"><i class="icon-x"></i><fmt:message>head.stop.force</fmt:message></a>
			<a id="interruptBtn"    href="javascript:void(0);" class="viewGroup btn btn-m"    				v-on:click="interrupt" style="display: none;"><fmt:message>head.interrupt</fmt:message></a>
			<a id="blockBtn" 	    href="javascript:void(0);" class="viewGroup btn btn-m"    				v-on:click="block" style="display: none;"><fmt:message>head.block</fmt:message></a>
			<a id="unblockBtn" 	    href="javascript:void(0);" class="viewGroup btn btn-m"   				v-on:click="unblock" style="display: none;"><fmt:message>head.unblock</fmt:message></a>
			<a id="updateReadyBtn" 	href="javascript:void(0);" class="btn btn-m" 		      				v-on:click="updateReady" style="display: none;"><fmt:message>head.retry</fmt:message></a>
