...
<script type="text/javascript">
  $(document).ready(function()
  {
    ...
    createPageObj.setSearchList([{
      ...
      'name' : "<fmt:message>igate.record</fmt:message> <fmt:message>head.group</fmt:message>",
    ...
    ControlImngObj.setConfig({
      controlUri : "<c:url value='/igate/migration/record/list.json' />"
    }) ;
    ...
    var vmList = new Vue({
      ...
      methods : $.extend(true, {}, listMethodOption, {
        ...
        make : function()
        {
          ...
          {
            MigrationImngObj.makeSubmit("<c:url value='/igate/migration/record/make.json' />", targetIdList, "<fmt:message>igate.migration.make</fmt:message>", function(result)
            {
      ...
      mounted : function()
      {
        ...
        this.makeGridObj.setConfig({
          ...
          searchUri : "<c:url value='/igate/migration/record/list.json' />",
          viewMode : "${viewMode}",
          ...
          columns : [{
            ...
            name : "recordDesc",
            header : "<fmt:message>igate.record</fmt:message> <fmt:message>head.description</fmt:message>",
            align : "left",
            width: "20%",
          }, {
            name : "recordType",
            header : "<fmt:message>igate.record</fmt:message> <fmt:message>head.type</fmt:message>",
            align : "center",
            width: "10%",
            formatter : function(value)
            {
              if (value.row.recordType == "H")
                return "Header" ;
              else if (value.row.recordType == "R")
                return "Reference" ;
            }
          }, {
            name : "recordGroup",
            header : "<fmt:message>igate.record</fmt:message> <fmt:message>head.group</fmt:message>",
            align : "left",
            width: "15%",
          }, {
            name : "privilegeId",
    ...
    window.vmMake = new Vue({
      ...
      methods : {
        ...
        migration : function()
        {
          MigrationImngObj.makeSubmit("<c:url value='/igate/migration/record/send.json' />", targetIdList, "<fmt:message>igate.migration.migration</fmt:message>", function(result)
          {
            window.vmMake.object = result.object ;
          }) ;
        }
    ...
    window.vmImport = new Vue({
      ...
      methods : {
        ...
        uploadFile : function()
        {
          ...
          $.ajax({
            url : "<c:url value='/igate/migration/record/import.json' />",
            data : data,
            cache : false,
            contentType : false,
            processData : false,
