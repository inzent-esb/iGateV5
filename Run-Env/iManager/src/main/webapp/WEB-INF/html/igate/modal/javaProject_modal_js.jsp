...
<%-- search init --%>
  var createPageObj = getCreatePageObj() ;
    ...
    createPageObj.setViewName('javaProjectModal') ;
    createPageObj.setIsModal(true) ;

    createPageObj.setSearchList([{
      'type' : "text",
      'mappingDataInfo' : "object.projectId",
      'name' : "<fmt:message>igate.javaProject.id</fmt:message>",
    ...
    var vmList = new Vue({
      ...
      mounted : function()
      {
        ...
        this.makeGridObj.setConfig({
          ...
          searchUri : "<c:url value='/igate/javaProject/searchPopup.json' />",
          viewMode : "${viewMode}",
