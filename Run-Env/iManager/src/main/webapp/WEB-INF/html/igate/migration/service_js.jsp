...
<script type="text/javascript">
  $(document).ready(function()
  {
      ...
      },
    {
      ...
      'name' : "<fmt:message>igate.service</fmt:message> <fmt:message>head.group</fmt:message>",
    ...
    createPageObj.setMainButtonList({
      ...
      importBtn : hasServiceEditor,
      makeBtn : hasServiceEditor,
      searchInitBtn : true,
    }) ;
    ...
    ControlImngObj.setConfig({
      controlUri : "<c:url value='/igate/migration/service/list.json' />",
    }) ;
    ...
    PropertyImngObj.getProperties('List.Service.ServiceType', true, function(serviceTypes){
	    ...
	    var vmList = new Vue({
	        ...
	        data : {
	          makeGridObj : null,
	          newTabPageUrl: "<c:url value='/igate/migration/service.html' />"
	        },
	        methods : $.extend(true, {}, listMethodOption, {
	          ...
	          make : function()
	          {
	            ...
	            {
	              MigrationImngObj.makeSubmit("<c:url value='/igate/migration/service/make.json' />", targetIdList, "<fmt:message>igate.migration.make</fmt:message>", function(result)
	              {
	        ...
	        mounted : function()
	        {
	          ...
	          this.makeGridObj.setConfig({
	            ...
	            searchUri : "<c:url value='/igate/migration/service/list.json' />",
	            viewMode : "${viewMode}",
	            ...
	            columns : [{
	              ...
	              name : "serviceGroup",
	              header : "<fmt:message>igate.service</fmt:message> <fmt:message>head.group</fmt:message>",
	              align : "left",
	              width: "15%",
	            }, {
	              name : "privilegeId",
    ...
    window.vmMake = new Vue({
      ...
      methods : {
        ...
        migration : function()
        {
          MigrationImngObj.makeSubmit("<c:url value='/igate/migration/service/send.json' />", targetIdList, "<fmt:message>igate.migration.migration</fmt:message>", function(result)
          {
            window.vmMake.object = result.object ;
          }) ;
        }
    ...
    window.vmImport = new Vue({
      ...
      methods : {
        ...
        uploadFile : function()
        {
          ...
          $.ajax({
            url : "<c:url value='/igate/migration/service/import.json' />",
            data : data,
            cache : false,
            contentType : false,
            processData : false,
