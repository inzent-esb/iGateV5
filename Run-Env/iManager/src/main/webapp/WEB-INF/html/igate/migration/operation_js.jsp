...
<script type="text/javascript">
  $(document).ready(function()
  {
    ...
    createPageObj.setSearchList([{
      ...
      'name' : "<fmt:message>igate.operation</fmt:message> <fmt:message>head.name</fmt:message>",
      'placeholder' : "<fmt:message>head.searchName</fmt:message>"
    },{
        'type' : "select",
        'mappingDataInfo' : {
          'selectModel' : "object.operationType",
          'optionFor' : 'option in operationTypes',
          'optionValue' : 'option.pk.propertyKey',
          'optionText' : 'option.propertyValue',
          'optionIf': 'option.pk.propertyKey != "S"',
          'id' : 'operationTypes',
        },
        'name' : "<fmt:message>igate.operation</fmt:message> <fmt:message>head.type</fmt:message>",
        'placeholder' : "<fmt:message>head.all</fmt:message>"
    },{
      'type' : "text",
      'mappingDataInfo' : "object.operationGroup",
      'name' : "<fmt:message>igate.operation</fmt:message> <fmt:message>head.group</fmt:message>",
    ...
    createPageObj.setTabList([{
      ...
      'appendAreaList' : [{
        'getDetailArea' : function()
        {
          ...
          detailHtml += '		       <th style="height: 32px;"><fmt:message>igate.operation</fmt:message></th>' ;
          ...
          detailHtml += '	       </tr>' ;
          detailHtml += '	   </thead>' ;
          detailHtml += '	   <tr v-for="operation in object.operations" style="height: 28px;">' ;
          detailHtml += '	       <td>{{operation.operation.operationId}}({{operation.operation.operationName}})</td>' ;
          detailHtml += '        <td valign="top">' ;
          detailHtml += '            <table width="100%">' ;
          detailHtml += '                <tr>' ;
          detailHtml += '                    <td width="20%"><fmt:message>igate.operation</fmt:message></td>' ;
          detailHtml += '                    <td>' ;
          detailHtml += '                        <table width="100%">' ;
          detailHtml += '                            <tr>' ;
          detailHtml += '                                <td>{{operation.operation.operationId}}({{operation.operation.operationName}})</td>' ;
          ...
          detailHtml += '                    </td>' ;
          detailHtml += '               </tr>' ;
          detailHtml += '				  <tr v-if="operation.operation.referenceMappings.length">' ;
          detailHtml += '				      <td width="30%"><fmt:message>igate.mapping</fmt:message></td>' ;
          detailHtml += '					  <td>' ;
          detailHtml += '					      <table width="100%">' ;
          detailHtml += '						      <tr v-for="referenceMapping in operation.operation.referenceMappings">' ;
          detailHtml += '							      <td>{{referenceMapping.mappingId}}({{referenceMapping.mappingName}})</td>' ;
          detailHtml += '							  </tr>' ;
          detailHtml += '						  </table>' ;
          detailHtml += '					 </td>' ;
          detailHtml += '				 </tr>' ;
          ...
          detailHtml += '       <td valign="top">' ;
          detailHtml += '           <table width="100%">' ;
          detailHtml += '               <tr v-if="operation.referRecords.length">' ;
          detailHtml += '                   <td width="30%"><fmt:message>igate.record</fmt:message></td>' ;
          detailHtml += '                   <td>' ;
          detailHtml += '                       <table width="100%">' ;
          detailHtml += '                           <tr v-for="referRecord in operation.referRecords">' ;
          detailHtml += '                              <td>{{referRecord.recordId}}({{referRecord.recordName}})</td>' ;
          detailHtml += '                           </tr>' ;
          detailHtml += '                       </table>' ;
          detailHtml += '                   </td>' ;
          detailHtml += '              </tr>' ;
          detailHtml += '               <tr v-if="operation.referOperations.length">' ;
          detailHtml += '                   <td width="30%"><fmt:message>igate.operation</fmt:message></td>' ;
          detailHtml += '                   <td>' ;
          detailHtml += '                       <table width="100%">' ;
          detailHtml += '                           <tr v-for="referOperation in operation.referOperations">' ;
    ...
    ControlImngObj.setConfig({
      controlUri : "<c:url value='/igate/migration/operation/list.json' />"
    }) ;

    PropertyImngObj.getProperties('List.Operation.OperationType', true, function(operationTypes){
	    ...
	    window.vmSearch = new Vue({
	      ...
	      methods : {
	        ...
	        initSearchArea : function(searchCondition)
	        {
	          ...
	          initSelectPicker($('#' + createPageObj.getElementId('ImngSearchObject')).find('#operationTypes'), this.object.operationType) ;
	        },
	    ...
	    var vmList = new Vue({
	        ...
	        methods : $.extend(true, {}, listMethodOption, {
	          ...
	          make : function()
	          {
	            ...
	            {
	              targetIdList[idx] = item.operationId ;
	              makeData = makeData + "targetIds=" + item.operationId + "&" ;
	            }) ;
	            ...
	            {
	              MigrationImngObj.makeSubmit("<c:url value='/igate/migration/operation/make.json' />", targetIdList, "<fmt:message>igate.migration.make</fmt:message>", function(result)
	              {
	        ...
	        mounted : function()
	        {
	          ...
	          this.makeGridObj.setConfig({
	            ...
	            searchUri : "<c:url value='/igate/migration/operation/list.json' />",
	            viewMode : "${viewMode}",
	            ...
	            columns : [{
	              ...
	              name : "operationName",
	              header : "<fmt:message>igate.operation</fmt:message> <fmt:message>head.name</fmt:message>",
	              align : "left",
	              width: "20%",
	            }, {
	              name : "operationDesc",
	              header : "<fmt:message>igate.operation</fmt:message> <fmt:message>head.description</fmt:message>",
	              align : "left",
	              width: "20%",
	            }, {
	              name : "operationType",
	              header : "<fmt:message>igate.operation</fmt:message> <fmt:message>head.type</fmt:message>",
	              align : "center",
	              width: "15%",
	              formatter : function(value)
	              {
	                if (value.row.operationType == "A")
	                  return "Adapter" ;
	                else if (value.row.operationType == "I")
	                  return "Interface" ;
	                else if (value.row.operationType == "S")
	                  return "Service" ;
	                else if (value.row.operationType == "J")
	                  return "Job" ;
	                else if (value.row.operationType == "U")
	                  return "User" ;
	              }
	            }, {
	              name : "operationGroup",
	              header : "<fmt:message>igate.operation</fmt:message> <fmt:message>head.group</fmt:message>",
	              align : "left",
	              width: "15%",
	            }, {
	              name : "privilegeId",
    ...
    window.vmMake = new Vue({
      ...
      methods : {
        downloadFile : function()
        {
          ...
          var url = "<c:url value='/igate/migration/operation/down.json?' />" + makeData ;
        ...
        migration : function()
        {
          MigrationImngObj.makeSubmit("<c:url value='/igate/migration/operation/send.json' />", targetIdList, "<fmt:message>igate.migration.migration</fmt:message>", function(result)
          {
            window.vmMake.object = result.object ;
          }) ;
        }
    ...
    window.vmImport = new Vue({
      ...
      methods : {
        ...
        uploadFile : function()
        {
          ...
          $.ajax({
            url : "<c:url value='/igate/migration/operation/import.json' />",
            data : data,
            cache : false,
            contentType : false,
            processData : false,
