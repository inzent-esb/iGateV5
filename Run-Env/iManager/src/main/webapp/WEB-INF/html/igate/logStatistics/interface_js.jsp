...
$(document).ready(function(){
	...
	PropertyImngObj.getProperties('List.LogStats.interface.statsDataTypes',false, function(pstatsDataTypes){
    	...
    	PropertyImngObj.getProperties('List.LogStats.SearchType', true, function(pDailyTime){
				...
				el : '#' + createPageObj.getElementId('ImngSearchObject'),
		      	data : {
		        	...
		        	object : {
		                ...
		                toDateTime : null,
		                searchType : "D",
		                pk : {statsType : " ", interfaceServiceId : null}
		      	...
		      	methods: {
	   	        	...
	   	        	downloadFile: function(){
		   				...
		   				req.open("POST", "<c:url value='/igate/logStatistics/generateExcelInterface.json' />", true);
    		...
    		var vmList = new Vue({
    			...
    			data : {
    	 			...
    	 			timeoutCount : 0,
    	 			makeGridObj: null,
    	 			newTabPageUrl: "<c:url value='/igate/logStatistics/interface.html' />"
    	      	},
    	        ...
    	        mounted: function() {
    	        	...
    	        	this.makeGridObj.setConfig({
    	        	    ...
    	        	    searchUri : "<c:url value='/igate/logStatistics/interfaceList.json' />",
    	        	    viewMode : "${viewMode}",
