...
<span id="fileResult" style="display: none;">
	...
	<div class="col-lg-6" v-show="object.operations">
	...
	<div class="col-lg-12" v-show="object.operations">
		<div class="form-group" style="margin-bottom: 16px;">
			<table class="migration-table" width="100%">
				...
				<thead>
					<tr align="center" style="background-color: #f5f6fb;">
						<th><fmt:message>igate.operation</fmt:message></th>
						<th><fmt:message>igate.migration.includeList</fmt:message></th>
					</tr>
				</thead>
				<tr v-for="operation in object.operations">
					<td>{{operation.operation.operationId}}({{operation.operation.operationName}})</td>
					<td valign='top'>
						<table width="100%">
							<tr>
								<td width="20%"><fmt:message>igate.operation</fmt:message></td>
								<td>
									<table width="100%">
										<tr>
											<td>{{operation.operation.operationId}}({{operation.operation.operationName}})</td>
