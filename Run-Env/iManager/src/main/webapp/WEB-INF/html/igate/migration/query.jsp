...
<span id="fileResult" style="display: none;">
	...
	<div class="col-lg-6" v-show="object.queries">
	...
	<div class="col-lg-12" v-show="object.queries">
		<div class="form-group" style="margin-bottom: 16px;">
			<table class="migration-table" width="100%">
				...
				<thead>
					<tr align="center" style="background-color: #f5f6fb;">
						<th><fmt:message>igate.query</fmt:message></th>
						<th><fmt:message>igate.migration.includeList</fmt:message></th>
					</tr>
				</thead>
				<tr v-for="query in object.queries">
					<td>{{query.query.queryId}}({{query.query.queryName}})</td>
					<td valign='top'>
						<table width="100%">
							<tr>
								<td width="20%" ><fmt:message>igate.query</fmt:message></td>
								<td>
									<table width="100%">
										<tr>
											<td>{{query.query.queryId}}({{query.query.queryName}})</td>
							...
							<tr v-if="query.query.inputRecordObject">
								<td width="30%" ><fmt:message>igate.record</fmt:message></td>
								<td>
									<table width="100%">
										<tr>
											<td>{{query.query.inputRecordObject.recordId}}({{query.query.inputRecordObject.recordName}})</td>
										</tr>
										<tr v-if="query.query.outputRecordObject">
											<td>{{query.query.outputRecordObject.recordId}}({{query.query.outputRecordObject.recordName}})</td>
										</tr>
									</table>
								</td>
							</tr>
