...
$(document).ready(function(){
	...
	createPageObj.setPanelButtonList({
		dumpBtn: hasServiceRestrictionEditor,
		removeBtn: hasServiceRestrictionEditor,
		goModBtn: hasServiceRestrictionEditor,
		saveBtn: hasServiceRestrictionEditor,
		updateBtn: hasServiceRestrictionEditor,
		goAddBtn: hasServiceRestrictionEditor,
	});
	
	createPageObj.panelConstructor();	

	SaveImngObj.setConfig({
		objectUri : "<c:url value='/igate/serviceRestriction/object.json' />"
	});

	ControlImngObj.setConfig({
		controlUri : "<c:url value='/igate/serviceRestriction/control.json' />"
	});	
	
	PropertyImngObj.getProperties('List.ServiceRestriction.Type', true, function(restrictionType){
		...
		PropertyImngObj.getProperties('List.Yn', true, function(enableYn){
			...
			var vmList = new Vue({
				...
				methods : $.extend(true, {}, listMethodOption, {
					...
					reorder : function(){
					  ReorderImngObj.reorder("<c:url value='/igate/serviceRestriction/reorder.json'/>") ;
					}
				}),
				mounted: function() {
					...
					this.makeGridObj.setConfig({
						...
						searchUri : "<c:url value='/igate/serviceRestriction/search.json' />",
						viewMode : "${viewMode}",
	...
	window.vmMain = new Vue({
		...
		created : function() {
			PropertyImngObj.getProperties('List.ServiceRestriction.Type', true, function(properties) {
	...
	window.vmServiceRestrictionConds = new Vue({
		...
		methods : {
			serviceRestrictionCondAdd : function() // 라인 추가 
			{
			...
			serviceRestrictionCondRemove : function(index) // 라인 삭제
			{
		...
		{
			PropertyImngObj.getProperties('List.ServiceRestriction.Type', true, function(restrictionTypes) 
				{
