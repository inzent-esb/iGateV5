	...
	<script>
		...
		document.querySelector('#adapter').addEventListener('ready', function(evt) {
			...
			new HttpReq('/api/page/properties').read({ pk : { propertyId: 'List.LogStats.SearchType' }, orderByKey: true }, function (searchTypeResult) {
			    new HttpReq('/api/page/properties').read({ pk : { propertyId: 'List.LogStats.online.statsDataTypes' }, orderByKey: true }, function (statsDataTypesResult) {
			        ...
			        var vmList = new Vue({
			            ...
			            methods: $.extend(true, {}, listMethodOption, {
			                ...
			                downloadFile: function () {
			                	...
			                	downloadFileFunc({
				        			url : '/api/logStats/apimApp/adapter/download',  
				        			param : param,
				        			fileName : '<fmt:message>igate.logStatistics.apimCustomerStatistics</fmt:message>_<fmt:message>head.excel.output</fmt:message>_' + Date.now() + '.xlsx'
				        		});
			                }
			            }),
			            mounted: function () {
			                ...
			                this.makeGridObj.setConfig({
			                    ...
			                    searchUrl: '/api/logStats/apimApp/adapter',
					    		paging: {
					    			isUse: true,
					    			side: "client"
					    		},
