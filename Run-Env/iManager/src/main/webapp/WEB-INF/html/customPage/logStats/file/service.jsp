	...
	<script>
		...
		document.querySelector('#service').addEventListener('ready', function(evt) {
			...
			new HttpReq('/api/page/properties').read({ pk: { propertyId: 'List.LogStats.SearchType' }, orderByKey: true }, function (searchTypeResult) {
			    new HttpReq('/api/page/properties').read({ pk: { propertyId: 'List.LogStats.service.statsDataTypes' }, orderByKey: true }, function (statsDataTypesResult) {
			        ...
			        var vmList = new Vue({
			            ...
			            methods: $.extend(true, {}, listMethodOption, {
			                ...
			                downloadFile: function () {
			                	downloadFileFunc({
				        			url : '/api/logStats/file/service/download',  
			            ...
			            mounted: function () {
			                ...
			                this.makeGridObj.setConfig({
			                    ...
			                    searchUrl: '/api/logStats/file/service',
					    		paging: {
					    			isUse: true,
					    			side: "client"
					    		},
