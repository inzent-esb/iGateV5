...
<body>
	...
	document.querySelector('#instance').addEventListener('ready', function(evt) {
		...
		SaveImngObj.setConfig({
		    objectUrl: '/api/entity/instance/object'
		});

		ControlImngObj.setConfig({
		    controlUrl: '/api/entity/instance/control',
		...
		new HttpReq('/api/page/properties').read({ pk : { propertyId: 'List.Instance.InstanceType' }, orderByKey: true }, function (instanceTypeResult) {
		    new HttpReq('/api/page/properties').read({ pk : { propertyId: 'List.LogLevel' }, orderByKey: false }, function (logLevelResult) {
		        new HttpReq('/api/page/properties').read({ pk : { propertyId: 'List.Yn' }, orderByKey: false }, function (downStatusResult) {
		            ...
		            window.vmInstanceProperties = new Vue({
		                ...
		                mounted: function () {
		                	 new HttpReq('/api/page/properties').read({ pk : { propertyId: 'Property.Instance' }, orderByKey: true }, function (instranceListResult) {
