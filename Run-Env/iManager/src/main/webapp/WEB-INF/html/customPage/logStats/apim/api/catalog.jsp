			        ...
			        var vmList = new Vue({
			            ...
			            methods: $.extend(true, {}, listMethodOption, {
			                ...
			                downloadFile: function () {
			                	...
			                	downloadFileFunc({
				        			url : '/api/logStats/apimApi/adapter/download',  
				        			param : param,
				        			fileName : '<fmt:message>igate.logStatistics.apimCatalogStatistics</fmt:message>_<fmt:message>head.excel.output</fmt:message>_' + Date.now() + '.xlsx'
				        		});
			                }
			            }),
			            mounted: function () {
			                ...
			                this.makeGridObj.setConfig({
			                    ...
			                    searchUrl: '/api/logStats/apimApi/adapter',
					    		paging: {
					    			isUse: true,
					    			side: "client"
					    		},
