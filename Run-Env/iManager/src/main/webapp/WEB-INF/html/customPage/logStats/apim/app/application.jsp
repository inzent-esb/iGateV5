	...
	<script>
		...
		document.querySelector('#interface').addEventListener('ready', function(evt) {
			...
			createPageObj.setSearchList([
			    ...
			    {
			        type: 'text',
			        mappingDataInfo: 'object.pk.interfaceServiceId',
			        regExpType: 'searchId',
			        name: 'Application ID',
			        placeholder: '<fmt:message>head.searchId</fmt:message>'
			    },
			        ...
			        var vmList = new Vue({
			            ...
			            methods: $.extend(true, {}, listMethodOption, {
			                ...
			                downloadFile: function () {
			                	...
			                	downloadFileFunc({
				        			url : '/api/logStats/apimApp/interface/download',  
				        			param : param,
				        			fileName : '<fmt:message>igate.logStatistics.apimApplicationStatistics</fmt:message>_<fmt:message>head.excel.output</fmt:message>_' + Date.now() + '.xlsx'
				        		});
			                }
			            }),
			            mounted: function () {
			                ...
			                this.makeGridObj.setConfig({
			                    ...
			                    searchUrl: '/api/logStats/apimApp/interface',
					    		paging: {
					    			isUse: true,
					    			side: "client"
					    		},
