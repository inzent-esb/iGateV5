			        ...
			        var vmList = new Vue({
			            ...
			            methods: $.extend(true, {}, listMethodOption, {
			                ...
			                downloadFile: function () {
			                	downloadFileFunc({
				        			url : '/api/logStats/online/adapter/download',  
				        			param : window.vmSearch.object,
				        			fileName : '<fmt:message>igate.logStatistics.adapterStatistics</fmt:message>_<fmt:message>head.excel.output</fmt:message>_' + Date.now() + '.xlsx'
				        		});
			                }
			            }),
			            mounted: function () {
			                ...
			                this.makeGridObj.setConfig({
			                    ...
			                    searchUrl: '/api/logStats/online/adapter',
					    		paging: {
					    			isUse: true,
					    			side: "client"
					    		},
