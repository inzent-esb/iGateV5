	...
	<script>
		...
		document.querySelector('#adapter').addEventListener('ready', function(evt) {
			...
			new HttpReq('/api/page/properties').read({ pk: { propertyId: 'List.LogStats.SearchType' }, orderByKey: true }, function (searchTypeResult) {
			    new HttpReq('/api/page/properties').read({ pk: { propertyId: 'List.LogStats.file.statsDataTypes' }, orderByKey: true }, function (statsDataTypesResult) {
			        ...
			        var vmList = new Vue({
			            ...
			            methods: $.extend(true, {}, listMethodOption, {
			                ...
			                downloadFile: function () {
			                	downloadFileFunc({ 
				        			url : '/api/logStats/file/adapter/download',  
			            ...
			            mounted: function () {
			                ...
			                this.makeGridObj.setConfig({
			                    ...
			                    searchUrl: '/api/logStats/file/adapter',
					    		paging: {
					    			isUse: true,
					    			side: "client"
					    		},
