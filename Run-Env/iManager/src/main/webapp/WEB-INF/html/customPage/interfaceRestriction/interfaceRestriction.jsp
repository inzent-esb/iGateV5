	...
	<script>
		document.querySelector('#interfaceRestriction').addEventListener('ready', function(evt) {
			...
			SaveImngObj.setConfig({
			    objectUrl: '/api/entity/interfaceRestriction/object'
			});

			ControlImngObj.setConfig({
			    controlUrl: '/api/entity/interfaceRestriction/control',
			    dumpUrl: '/api/entity/interfaceRestriction/dump'
			});

			new HttpReq('/api/page/properties').read({ pk : { propertyId: 'List.Yn' }, orderByKey: true }, function (interfaceRestrictionYnResult) {
				new HttpReq('/api/page/properties').read({ pk : { propertyId: 'List.InterfaceRestriction.Type' }, orderByKey: true }, function (restrictionTypeListResult) {
					new HttpReq('/api/page/properties').read({ pk : { propertyId: 'List.TransactionRestriction.Operator' }, orderByKey: true }, function (restrictionOperatorListResult) {
		                ...
		                var vmList = new Vue({
		                    ...
		                    mounted: function () {
		                        ...
		                        this.makeGridObj.setConfig({
						            ...
						            searchUrl: '/api/entity/interfaceRestriction/search',
		            	...
		            	window.vmInterfaceRestrictionConds = new Vue({
		            		...
		            		methods: {
		            			...
		            			interfaceRestrictionCondAdd: function() {
		            			...
		            			interfaceRestrictionCondRemove: function(index) {
		            		...
		            		created: function() {
		            			new HttpReq('/api/page/properties').read({ pk : { propertyId: 'List.InterfaceRestriction.Type' }, orderByKey: true }, function (restrictionTypesResult) {
			...
			function changeTime(pTime, isDisplay) {
			    ...
			    if (!isDisplay) {
			        ...
			        var dateFormat = constants.interfaceRestrictionDateFormat;
			...
			function initDateSearchPicker(vueObj, dateSelector) {
				if ('HHmmss' == constants.interfaceRestrictionDateFormat) {
