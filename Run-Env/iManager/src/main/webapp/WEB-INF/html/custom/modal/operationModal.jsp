...
<body>
	...
	$(document).ready(function() {
		...
		new HttpReq('/common/property/properties.json').read({ propertyId: 'List.Operation.OperationType', orderByKey: true }, function (operationTypeResult) {
		    ...
		    var vmList = new Vue({
		        ...
		        mounted: function () {
		            ...
		            this.makeGridObj.setConfig({
		                ...
		                searchUri: '/igate/operation/searchPopup.json',
		                viewMode: '${viewMode}',
