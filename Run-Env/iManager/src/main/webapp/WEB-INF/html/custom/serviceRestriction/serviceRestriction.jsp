	...
	<script>
		document.querySelector('#serviceRestriction').addEventListener('ready', function(evt) {
			...
			SaveImngObj.setConfig({
			    objectUri: '/igate/serviceRestriction/object.json'
			});

			ControlImngObj.setConfig({
			    controlUri: '/igate/serviceRestriction/control.json'
			});

			new HttpReq('/common/property/properties.json').read({ propertyId: 'List.Yn', orderByKey: true }, function (serviceRestrictionYnResult) {
			    new HttpReq('/common/property/properties.json').read({ propertyId: 'List.ServiceRestriction.Type', orderByKey: true }, function (restrictionTypeListResult) {
			        new HttpReq('/common/property/properties.json').read({ propertyId: 'List.TransactionRestriction.Operator', orderByKey: true }, function (restrictionOperatorListResult) {
			            new HttpReq('/igate/serviceRestriction/dateFormat.json').read(null, function (dateFormatResult) {
			                    ...
			                    methods: $.extend(true, {}, searchMethodOption, {
			                        ...
			                        search: function () {
			                            ...
			                            vmList.makeGridObj.search(
			                                this,
			                                function () {
			                                    new HttpReq('/igate/serviceRestriction/rowCount.json').read(this.object, function (result) {
			                ...
			                var vmList = new Vue({
			                    ...
			                    mounted: function () {
			                        ...
			                        this.makeGridObj.setConfig({
			                            ...
			                            searchUri: '/igate/serviceRestriction/search.json',
			                            viewMode: '${viewMode}',
