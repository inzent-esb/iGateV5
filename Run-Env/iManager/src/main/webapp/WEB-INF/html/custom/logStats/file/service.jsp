			            ...
			            methods: $.extend(true, {}, searchMethodOption, {
			                ...
			                initDatePicker: function () {
			                    ...
			                    fromDateTime.customDateRangePicker(
			                        ...
			                        Object.assign({ startDate: this.object.fromDateTime }, datePickerInfo)
			                    );
			                },
			        ...
			        var vmList = new Vue({
			            ...
			            methods: $.extend(true, {}, listMethodOption, {
			                ...
			                downloadFile: function () {
			                    ...
			                    req.open('POST', '${prefixUrl}/igate/logStatistics/generateExcelFileService.json', true);
			            ...
			            mounted: function () {
			                ...
			                this.makeGridObj.setConfig({
			                    ...
			                    searchUri: '/igate/logStatistics/fileServiceList.json',
			                    viewMode: '${viewMode}',
