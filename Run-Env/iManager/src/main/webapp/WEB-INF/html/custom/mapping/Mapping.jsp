	...
	<script>
		document.querySelector('#mapping').addEventListener('ready', function(evt) {
			...
			SaveImngObj.setConfig({
			    objectUri: '/igate/mapping/object.json'
			});

			ControlImngObj.setConfig({
			    controlUri: '/igate/mapping/control.json'
			});
			    ...
			    mounted: function () {
			        ...
			        this.makeGridObj.setConfig({
			            ...
			            onClick: function (loadParam, ev) {
			                SearchImngObj.clicked({ mappingId: loadParam.mappingId });
			            },
			            searchUri: '/igate/mapping/search.json',
			            viewMode: '${viewMode}',
