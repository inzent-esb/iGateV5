		...
		document.querySelector('#interface').addEventListener('ready', function(evt) {
			                ...
			                var vmList = new Vue({
			                    ...
			                    methods: $.extend(true, {}, listMethodOption, {
			                        ...
			                        make: function () {
			                            ...
			                            if (0 == targetIdList.length) {
			                                ...
			                                MigrationImngObj.makeSubmit('/igate/migration/interface/make.json', targetIdList, '<fmt:message>igate.migration.make</fmt:message>', function (result) {
			                    ...
			                    mounted: function () {
			                        ...
			                        this.makeGridObj.setConfig({
			                            ...
			                            onClick: function () {},
			                            searchUri: '/igate/migration/interface/list.json',
			                            viewMode: '${viewMode}',
			...
			window.vmMake = new Vue({
			    ...
			    methods: {
			        ...
			        migration: function () {
			            MigrationImngObj.makeSubmit('/igate/migration/interface/send.json', targetIdList, '<fmt:message>igate.migration.migration</fmt:message>', function (result) {
			                window.vmMake.object = result.object;
			            });
			        }
			    }
			...
			window.vmImport = new Vue({
			    ...
			    methods: {
			        ...
			        uploadFile: function () {
			            ...
			            $.ajax({
			                url: "<c:url value='/igate/migration/interface/import.json?_method=POST' />",
			                data: data,
			                cache: false,
			                contentType: false,
			                processData: false,
