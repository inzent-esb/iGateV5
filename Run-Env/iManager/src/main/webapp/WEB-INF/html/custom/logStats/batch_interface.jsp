	...
	<script>
		...
		document.querySelector('#interface').addEventListener('ready', function(evt) {
			...
			(new HttpReq('/common/property/properties.json')).read({ propertyId: 'List.LogStats.SearchType', orderByKey: true }, function(searchTypeResult) {
				(new HttpReq('/common/property/properties.json')).read({ propertyId: 'List.LogStats.interface.statsDataTypes', orderByKey: true }, function(statsDataTypesResult) {
					...
					var vmList = new Vue({
				        ...
				        methods: $.extend(true, {}, listMethodOption, {
				        	...
				        	downloadFile: function() {
				        		...
				        		['fromDateTime', 'toDateTime', 'pk.statsType', 'pk.interfaceServiceId', 'searchType'].forEach(function(key) {
		                        ...
		                        req.open("POST", "${prefixUrl}/igate/logStatistics/generateExcelInterface.json", true);
		                        ...
		                        req.onload = function (event) {
		                        	...
		                        	var file_name = "<fmt:message>igate.logStatistics.batchInterfaceStatistics</fmt:message>_<fmt:message>head.excel.output</fmt:message>_" + Date.now() + ".xlsx";
				        ...
				        mounted: function() {
				        	...
				        	this.makeGridObj.setConfig({
				        		...
				        		searchUri: "/igate/logStatistics/batchInterfaceList.json",
				        		viewMode: "${viewMode}",
				                ...
				                pageOptions: {
				              	...
				              	columns: [		              		
									...
									
									{
										...
										sortable: true,
										formatter: function(info) {
											return numberWithComma(info.row.count01);
										}								
									},
									{
										name: 'count02',
										...
										sortable: true,
										formatter: function(info) {
											return numberWithComma(info.row.count02);
										}								
									},
									{
										name: 'count03',
										...
										sortable: true,
										formatter: function(info) {
											return numberWithComma(info.row.count03);
										}								
									},
									{
										name: 'count04',
										...
										sortable: true,
										formatter: function(info) {
											return numberWithComma(info.row.count04);
										}								
									},
									{
										name: 'count05',
