			        ...
			        var vmList = new Vue({
			            ...
			            methods: $.extend(true, {}, listMethodOption, {
			                ...
			                downloadFile: function () {
			                    ...
			                    req.open('POST', '${prefixUrl}/igate/logStatistics/generateExcelOnlineInterface.json', true);
			                    ...
			                    req.onload = function (event) {
			                        ...
			                        var file_name = '<fmt:message>igate.logStatistics.interfaceStatistics</fmt:message>_<fmt:message>head.excel.output</fmt:message>_' + Date.now() + '.xlsx';
			            ...
			            mounted: function () {
			                ...
			                this.makeGridObj.setConfig({
			                    ...
			                    searchUri: '/igate/logStatistics/onlineInterfaceList.json',
			                    viewMode: '${viewMode}',
