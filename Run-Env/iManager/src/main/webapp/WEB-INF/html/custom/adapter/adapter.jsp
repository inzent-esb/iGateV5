				...
				window.vmSearch = new Vue({
				    ...
				    methods: $.extend(true, {}, searchMethodOption, {
				        ...
				        initSearchArea: function (searchCondition) {
				            ...
				            initSelectPicker($('#' + createPageObj.getElementId('ImngSearchObject')).find('#adapterTypes'), this.object.adapterType);
			...
			window.vmMain = new Vue({
			    ...
			    created: function () {
			        new HttpReq('/common/property/properties.json').read(
			            { propertyId: 'List.Adapter.Type', orderByKey: true },
			            function (result) {
			                this.adapterTypeList = result.object;
			            }.bind(this)
			        );
			        new HttpReq('/common/property/properties.json').read(
			        ...
			        new HttpReq('/common/property/properties.json').read(
			            { propertyId: 'List.Adapter.Queuemode', orderByKey: true },
			            function (result) {
			                this.adapterQueueModeList = result.object;
			            }.bind(this)
			        );
			        new HttpReq('/common/property/properties.json').read(
