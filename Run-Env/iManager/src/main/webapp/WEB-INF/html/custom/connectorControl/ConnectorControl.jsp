	...
	<script>
		document.querySelector('#connectorControl').addEventListener('ready', function(evt) {
			...
			SaveImngObj.setConfig({
			    objectUri: '/igate/connectorControl/object.json'
			});

			ControlImngObj.setConfig({
			    controlUri: '/igate/connectorControl/control.json'
			});
			
			
	        new HttpReq('/igate/instance/list.json').read(null, function (instanceIdResult) {
	        	new HttpReq('/common/property/properties.json').read({ propertyId: 'List.Connector.StatusInfo', orderByKey: true }, function (statusInfoResult) {
	    			...
	    			window.vmList = new Vue({
	    			    ...
	    			    mounted: function () {
	    			        ...
	    			        this.makeGridObj.setConfig({
	    			            ...
	    			            searchUri: '/igate/connectorControl/searchSnapshot.json',
	    			            viewMode: '${viewMode}',
