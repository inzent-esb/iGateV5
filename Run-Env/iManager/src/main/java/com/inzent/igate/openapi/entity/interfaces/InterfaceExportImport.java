package com.inzent.igate.openapi.entity.interfaces ;
...
@Component
public class InterfaceExportImport implements EntityExportImportBean<Interface>
{
  @Override
  public void exportList(HttpServletRequest request, HttpServletResponse response, Interface entity, List<Interface> list) throws Exception
  {
    ...
    generateDownload(request, response, "/template/List_Interface.xlsx", entity, list) ;

    response.flushBuffer() ;
  }

  @Override
  public void exportObject(HttpServletRequest request, HttpServletResponse response, Interface entity) throws Exception
  {
    throw new UnsupportedOperationException() ;
  }

  @Override
  public Interface importObject(MultipartFile multipartFile) throws Exception
  {
    throw new UnsupportedOperationException() ;
  }

	public void generateDownload(HttpServletRequest request, HttpServletResponse response, String templateFile, Interface entity, List<Interface> entityList) throws Exception
	{		
